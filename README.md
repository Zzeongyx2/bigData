# BigData
2021년 공공 빅데이터 분석 청년인재 양성 데이터 전문 교육 과정 학습/실습 정리
--------------
## SW 역량
#### 1. Python 프로그래밍 이해
...
##### 관광분석
* [관광분석 참조 모델](DAY_19/★(아이리포)분석참조모델_관광분석_소개(강의자료)_v1.0.pdf)
* [관광분석 실습](DAY_19/[서울1수목3]정윤영_관광실습결과.pdf)
##### 전기차 충전소
* [전기차 충전인프라 분석 참조모델](DAY_20/★(아이리포)분석참조모델(전기차)_실습교안_v2.2.pdf)
* [전기차 충전인프라 분석 실습](DAY_20/[서울1수목3]정윤영_전기차_실습과정.pdf)
#### 2. 텍스트 마이닝 분석 실습
* 텍스트마이닝 개요
* 민원분석참조모델 개요
* [민원분석참조모델 실습](DAY_18/[서울1수목3]정윤영_민원실습결과.pdf)
#### 3. DB이용 데이터 정제 활용 실습
